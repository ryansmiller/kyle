<?php
/**
 * Kyle Westaway - Minimal functions and definitions
 *
...
if ( ! function_exists( 'kyle_westaway_minimal_setup' ) ) :
/**
 ...
 */
function kyle_westaway_minimal_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Kyle Westaway - Minimal, use a find and replace
	 * to change 'kyle-westaway-minimal' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'kyle-westaway-minimal', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'kyle-westaway-minimal' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'kyle_westaway_minimal_custom_background_args', array(
...
add_action( 'after_setup_theme', 'kyle_westaway_minimal_setup' );
 ...
 */
function kyle_westaway_minimal_content_width() {
...
function kyle_westaway_minimal_scripts() {
	...
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/css/font-awesome.min.css', array(), '4.7.0', false );

	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array('jquery'), '3.3.7', true );

	wp_enqueue_script( 'custom', get_template_directory_uri() . '/js/custom.js', array('bootstrap'), null, true );
